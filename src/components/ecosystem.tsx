          ...
          {capabilities.map((cap, i) => {
            ...
            return (
              <motion.div
                ...
                className="border-hairline bg-elevated/60 hover:border-ember-400/40 hover:bg-elevated group relative rounded-3xl border p-8 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] sm:p-9"
              >
                <div className="flex items-center justify-between">
                  <span className="border-hairline bg-surface text-accent grid h-11 w-11 place-items-center rounded-xl border transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-0.5">
                ...
                <h3 className="text-fg mt-8 text-[1.5rem] font-medium tracking-[-0.03em]">
                  {cap.title}
                </h3>
                ...
                <span className="bg-ember-400 absolute inset-x-8 bottom-0 h-px origin-left scale-x-0 opacity-0 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-x-100 group-hover:opacity-60" />
              </motion.div>
            );
          })}
        </RevealGroup>
