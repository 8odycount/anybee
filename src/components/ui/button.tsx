...
type Variant = "primary" | "secondary" | "onImage" | "ghost";
type Size = "sm" | "md" | "lg";
...
const variants: Record<Variant, string> = {
  ...
  // Frosted glass on page surfaces
  secondary:
    "glass border text-fg hover:border-ember-400/45 hover:-translate-y-[1px] hover:shadow-[0_14px_40px_-20px_rgba(169,80,31,0.35)]",
  // Hairline on photography — no fill, so the motif stays readable through it
  onImage:
    "border border-white/30 text-white backdrop-blur-[2px] hover:border-white/70 hover:bg-white/10 hover:-translate-y-[1px]",
